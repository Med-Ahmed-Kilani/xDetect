...
def generate(eval_json: Path | None = None, out: Path | None = None) -> Path:
    ...
    lines = [
        ...
        "",
        "   NOTE: HC3 (QA domain) and MultiTuDe (news domain) are merged in",
        "   training.  Domain mismatch may confound cross-lingual results —",
        "   see per-generator breakdown in eval_results.json for details.",
        "",
